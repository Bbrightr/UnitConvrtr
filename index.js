...
const firstConv = document.getElementsByClassName("conv-dimen")
const colorMiniHeaders = document.getElementsByClassName("colorFirst")
const paragraphColor = document.getElementsByClassName("conColor")
const switchToLightMode = document.getElementById("dark-mode-btn")
...
toggleDark.addEventListener("click", function(){
    ...
    switchToLightMode.innerHTML = `
                                    ...
                                    `
    container.classList.toggle("darkBC")
    firstConv[0].classList.toggle("darkconversionBC")
    firstConv[1].classList.toggle("darkconversionBC")
    firstConv[2].classList.toggle("darkconversionBC")
    colorMiniHeaders[0].classList.toggle("colorSecond")
    colorMiniHeaders[1].classList.toggle("colorSecond")
    colorMiniHeaders[2].classList.toggle("colorSecond")
    paragraphColor[0].classList.toggle("paraColor")
    paragraphColor[1].classList.toggle("paraColor")
    paragraphColor[2].classList.toggle("paraColor")
